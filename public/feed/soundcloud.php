...
foreach ($obj as $item) {
	create_row(
		...
		"javascript:embedSound('#div-" . $item->id . "','" . $item->id . "')", // $href	i.e. "https://facebook.com/post1234"
		...
		$item->user->permalink_url, 	// $author_href	i.e. "https://facebook.com/user1234"
		$item->created_at,				// $date	i.e. "2014-01-01 00:00:00"
		($item->artwork_url ? $item->artwork_url : $item->user->avatar_url), // $thumbnail	i.e. "https://facebook.com/etc.png"
		'div-' . $item->id
	);
}
echo '</table>';
