...
<div class="row">
	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			...
			<h3 class="panel-title"><i class="fa fa-fw fa-book"></i> Website & Docs</div></h3>
			<div class="panel-body">
...
<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-default">
			...
			<h3 class="panel-title"><i class="fa fa-fw fa-money"></i> Donate</div></h3>
			<div class="panel-body">
	...
	<div class="col-lg-6">
		<div class="panel panel-default">
			...
			<h3 class="panel-title"><i class="fa fa-fw fa-flag"></i> Translations</div></h3>
			<div class="panel-body">
				<p>If your language is missing in LMMS, help the project and other users speaking the same language by translating the software. You can find instructions on the page "<a href="//github.com/LMMS/lmms/wiki/Creating-a-localization">Creating a localization</a>" in our GitHub Wiki.
			</div>
		</div>
	</div>
</div>
